    ...
    : dbpool::ConnectionPool(pool_size)
{
    ...
    start_optimization_thread(std::move(optimization_period), analysis_limit);
}
...
//!
//! \brief Uninitializes the sqlite3 library.
//!
